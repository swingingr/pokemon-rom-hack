...
const u16 gMetatiles_NE_General[] = INCBIN_U16("data/tilesets/primary/ne_general/metatiles.bin");
const u16 gMetatileAttributes_NE_General[] = INCBIN_U16("data/tilesets/primary/ne_general/metatile_attributes.bin");
